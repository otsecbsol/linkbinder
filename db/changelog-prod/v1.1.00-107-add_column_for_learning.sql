...
--changeset opentone:v1.1.00-107-add_column_for_learning

-- add columns
ALTER TABLE correspon ADD for_learning_src_id NUMBER(10, 0);
ALTER TABLE rep_v_correspon ADD for_learning_src_id NUMBER(10, 0);
-- replace vies
...
SELECT
    ...
    c.for_learning_src_id           AS for_learning_src_id,
