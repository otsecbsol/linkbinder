...
/**
 * FavoriteFilter を操作するDao.
 *
 * @author opentone
 *
 */
public interface FavoriteFilterDao extends GenericDao<FavoriteFilter> {
    /**
     * 該当する favorite filter を検索する.
     * @param condition
     *            検索条件
     * @return favorite filter 一覧
     */
    List<FavoriteFilter> find(SearchFavoriteFilterCondition condition);
}
