...
/**
 * 返信コレポン文書番号採番を操作するDao.
 *
 * @author opentone
 *
 */
public interface ReplyCorresponNoSeqDao extends GenericDao<ReplyCorresponNoSeq> {

    /**
     * 検索条件に該当する返信コレポン文書番号採番を検索する.
     * @param parentCorresponId
     *            親コレポン文書ID
     * @return 返信コレポン文書番号採番
     */
    ReplyCorresponNoSeq findForUpdate(Long parentCorresponId);
}
