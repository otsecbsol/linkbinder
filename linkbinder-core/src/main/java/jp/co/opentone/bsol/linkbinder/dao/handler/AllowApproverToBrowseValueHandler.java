...
/**
 * {@link AllowApproverToBrowse}とテーブルの列の値をマッピングするクラス.
 * @author opentone
 *
 */
public class AllowApproverToBrowseValueHandler extends EnumValueHandler {
    ...
    public EnumValue[] getValues() {
        return AllowApproverToBrowse.values();
    }
}
