...
/**
 * {@link EmailNoticeAddressType}とテーブルの列の値をマッピングするクラス.
 *
 * @author opentone
 *
 */
public class EmailNoticeAddressTypeValueHandler extends EnumValueHandler {
    ...
    public EnumValue[] getValues() {
        return EmailNoticeAddressType.values();
    }
}
