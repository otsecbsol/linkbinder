...
/**
 * {@link EmailNoticeReceivable}とテーブルの列の値をマッピングするクラス.
 *
 * @author opentone
 *
 */
public class EmailNoticeReceivableValueHandler extends EnumValueHandler {
    ...
    public EnumValue[] getValues() {
        return EmailNoticeReceivable.values();
    }
}
