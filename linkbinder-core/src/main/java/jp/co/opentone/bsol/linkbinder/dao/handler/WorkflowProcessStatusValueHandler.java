...
/**
 * {@link WorkflowProcessStatus}とテーブルの列の値をマッピングするクラス.
 * @author opentone
 *
 */
public class WorkflowProcessStatusValueHandler extends EnumValueHandler {
    ...
    public EnumValue[] getValues() {
        return WorkflowProcessStatus.values();
    }
}
