 ...
 * @author opentone
 */
public enum MasterDataImportType implements Code {
     ...
     *            ラベル
     */
    private MasterDataImportType(Integer value, String label) {
        this.value = value;
        this.label = label;
    }
    ...
    public static MasterDataImportType valueOf(Integer val) {
        for (MasterDataImportType e : values()) {
