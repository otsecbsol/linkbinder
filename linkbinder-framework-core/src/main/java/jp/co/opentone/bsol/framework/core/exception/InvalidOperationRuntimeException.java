...
public class InvalidOperationRuntimeException extends RuntimeException {
     ...
     * SerialVersionUID.
     */
    private static final long serialVersionUID = 7051468384739393935L;
     ...
     * メッセージを持たない例外を生成する.
     */
    public InvalidOperationRuntimeException() {
        super();
    }
     ...
     *            メッセージ
     */
    public InvalidOperationRuntimeException(String message) {
        super(message);
    }
     ...
     *            原因となった例外
     */
    public InvalidOperationRuntimeException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *            原因となった例外
     */
    public InvalidOperationRuntimeException(Message createdMesage, Throwable cause) {
        super(cause);
