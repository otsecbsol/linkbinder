...
import jp.co.opentone.bsol.framework.core.validation.constraints.MaxByteLength;

/**
 * 値が指定の長さ(バイト長)であるか検証するValidator.
 * @author opentone
 */
public class MaxByteLengthValidator implements ConstraintValidator<MaxByteLength, Object> {
