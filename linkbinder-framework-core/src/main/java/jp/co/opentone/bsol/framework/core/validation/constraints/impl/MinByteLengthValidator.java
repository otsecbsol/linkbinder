...
import jp.co.opentone.bsol.framework.core.validation.constraints.MinByteLength;

/**
 * 値が指定の長さ(バイト長)であるか検証するValidator.
 * @author opentone
 */
public class MinByteLengthValidator implements ConstraintValidator<MinByteLength, Object> {
     ...
     */
    @Override
    public void initialize(MinByteLength constraintAnnotation) {
