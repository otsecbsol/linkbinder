...
public class IntegerNullValueHandlerTest {

    private IntegerNullValueHandler handler;

    @Before
    public void setUp() {
        handler = new IntegerNullValueHandler();
    }
    ...
    public void testGetResult() throws Exception {
        Integer i = 1;
        MockResultGetter getter = new MockResultGetter(i);
        assertEquals(i, handler.getResult(getter));
    ...
    public void testSetParameter() throws Exception {
        Integer i = 2;
        MockParameterSetter setter = new MockParameterSetter(i);
        handler.setParameter(setter, i);

        setter = new MockParameterSetter(null);
        handler.setParameter(setter, DBValue.INTEGER_NULL);
    }
