...
public class StringNullValueHandlerTest {

    private StringNullValueHandler handler;

    @Before
    public void setUp() {
        handler = new StringNullValueHandler();
    }
    ...
    public void testGetResult() throws Exception {
        String s = "test";
        MockResultGetter getter = new MockResultGetter(s);
        assertEquals(s, handler.getResult(getter));
    ...
    public void testSetParameter() throws Exception {
        String s = "test";
        MockParameterSetter setter = new MockParameterSetter(s);
        handler.setParameter(setter, s);
        setter = new MockParameterSetter(null);
        handler.setParameter(setter, DBValue.STRING_NULL);
    }
    ...
    class MockResultGetter implements ResultGetter {
        ...
        public MockResultGetter(String value) {
            this.value = value;
        }
    ...
    class MockParameterSetter implements ParameterSetter {
        ...
        public MockParameterSetter(String expected) {
