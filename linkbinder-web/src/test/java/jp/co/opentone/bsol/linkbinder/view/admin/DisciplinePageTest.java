...
/**
 * {@link DisciplinePagePage}のテストケース.
 * @author opentone
 */
public class DisciplinePageTest extends AbstractTestCase {
    ...
    public void testInitializeSystemAdmin() throws Exception {
        ...
        discipline.setProjectNameE("Project First");
        ...
        MockDisciplineService.RET_FIND = discipline;

        page.initialize();

        page.getDiscipline();

        assertEquals(discipline.getDisciplineCd(), page.getDiscipline().getDisciplineCd());
        assertEquals(discipline.getName(), page.getDiscipline().getName());
        assertEquals(discipline.getProjectId(), page.getDiscipline().getProjectId());
        assertEquals(discipline.getProjectNameE(), page.getDiscipline().getProjectNameE());
        assertEquals(discipline.getCreatedBy().toString(), page.getDiscipline().getCreatedBy()
            .toString());
        assertEquals(discipline.getUpdatedBy().toString(), page.getDiscipline().getUpdatedBy()
            .toString());
        assertTrue(page.getDiscipline().getVersionNo() == 1L);
        assertTrue(page.getDiscipline().getDeleteNo() == 0L);
    }
